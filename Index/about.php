          ...
          <div class="row align-items-center justify-content-between">
            <div class="col-lg-5">
              <div class="service-content m-t-50">
                <h2 class="mb-4">
                  We are CryptoBroker, a multidisciplinary creative team
                </h2>
                <p>
                    Founded in 2017, CriptoBroker is a digital cryptocurrency platform where all users can invest,
                    they just need a few clicks. We offer cryptocurrencies such as Bitcoin, Ethereum and LiteCoin,
                    and every day we expand our portfolios, Greetings from California!
                </p>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-7 offset-lg-1 mt-4 mt-lg-0">
              <div class="row g-0">
                ...
                <div class="col-6 bg-yellow text-center py-5 py-md-7">
                  <h1 class="display-3 text-white">$100m</h1>
                  <p class="m-0 text-white">in funding</p>
                </div>

                <div class="col-6  text-center py-5 py-md-7">
                  <h1 class="display-3 text-white">2017</h1>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="service-content my-5">
                <h3>Working at CriptoBroker</h3>
                <p>
                  Digital currencies are changing how we use and think about
                  money. CriptoBroker, the most trusted company in the space, is
